...
namespace netbullAPI.Negocio
{
    public class NE_Endereco
    {
        ...
        public async Task<bool> AtualizaEnderecoPatchAsync(int idEndereco, AlterarEnderecoViewModel logradouro)
        {
            return await _daoEndereco.AtualizaEnderecoPatchAsync(idEndereco, logradouro);
        }
